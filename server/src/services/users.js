...
exports.get = get;
exports.getWithEmail = getWithEmail;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, db.query(query, [email])];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.rows[0]];
            }
...
function update(id, properties) {
    return __awaiter(this, void 0, void 0, function () {
        var setClauses, updateValues, index, query, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setClauses = [];
                    ...
                    Object.entries(properties).forEach(function (_a) {
                        ...
                        setClauses.push("".concat(key, " = $").concat(index));
                        if (value) {
                    ...
                    query = "UPDATE users SET ".concat(setClauses.join(", "), " WHERE user_id = $").concat(index, " RETURNING *;");
                    return [4 /*yield*/, db.query(query, __spreadArray(__spreadArray([], updateValues, true), [id], false))];
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.rows[0]];
            }
