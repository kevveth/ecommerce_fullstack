      ...
      <section className={styles.heroSection}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroTagline}>
            Craft Coffee, Extraordinary Flavor
          </p>
      ...
      <section className={styles.aboutSection}>
        <div className={styles.sectionContent}>
          ...
          <p className={styles.sectionText}>
            At Ken's Coffee Company, we believe that great coffee is an art
            form. Since 2015, we've been sourcing premium beans from sustainable
            farms, carefully roasting them to perfection, and delivering
            exceptional flavor in every cup. Our passion for quality and
      ...
      <section className={styles.productsSection}>
        ...
        <div className={styles.productGrid}>
          <div className={styles.productCard}>
            ...
            <p>
              A bright, balanced medium roast with notes of citrus and
              chocolate.
            </p>
          ...
          <div className={styles.productCard}>
            ...
            <p>
              Single-origin light roast with floral notes and subtle fruitiness.
            </p>
